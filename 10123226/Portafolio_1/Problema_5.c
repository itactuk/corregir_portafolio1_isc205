...
//Variables globales//-10 CUIDADO CON LAS VARIABLES GLOBALES INNECESARIAS
...
int main()
{
    int cantidad;
    int i;
    printf("Por favor indique la cantidad de numeros del arreglo: ");//se especifica la cantidad de
